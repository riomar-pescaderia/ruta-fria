...
const CATEGORIAS_GASTO = [
  ...
  {
    clave: 'flete_mercaderia',
    etiqueta: 'Flete de mercadería',
    descripcion: 'Flete y logística para traer la mercadería que se compra para revender (no la del reparto a clientes, ver "Combustible y viáticos" o el subtipo de fletes en Servicios para eso). Se carga a mano, como cualquier otra categoría que no es "Mercadería" — pero en los informes se suma junto con "Mercadería" al costo y a la rentabilidad, porque el precio de venta ya asume ese flete (ver el flete % de cada artículo).',
    subtipos: [],
  },
  {
    clave: 'insumos',
