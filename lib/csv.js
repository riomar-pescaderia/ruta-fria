...
// encabezados sin ambigüedad. En particular NO mapea una columna llamada
// simplemente "Flete", porque en la planilla de costos de Ruta Fría esa
// columna trae un monto ya calculado, no un porcentaje — mapearla directo
// cargaría un flete_pct completamente erróneo.
const ALIAS = {
  ...
  contenido_gr: ['contenido_gr', 'contenido (g)', 'contenido gr', 'gramos por unidad', 'gr por unidad', 'gramos', 'peso por unidad (g)'],
};
